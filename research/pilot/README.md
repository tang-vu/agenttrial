...
The LLM-judge baseline remains excluded until a zero-cost local model, runtime, prompt, and output schema are frozen. The preregistered main study remains blocked on independent targets, authorization and data-governance approval, the nearest-work boundary, and the full 20-repeat run.
