...
The remaining technical gate is creation of controlled candidate executions for the 10 BFCL and 10 tau2 targets. The two synthetic adapter candidates are not study evidence, and active external testing remains disabled. Independent construct-mapping review is still required before main-study inference.
