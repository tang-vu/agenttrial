...
The remaining technical gate is exhaustive label-blinded projection for the 50 independent AgentChaosBench traces and creation of the controlled candidate executions for the other 30 targets. Public AgentDojo runs are schema validation only, the two synthetic adapter candidates are not study evidence, and active external testing remains disabled.
