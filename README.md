...
The frozen judge snapshot is [AgentTrial v0.7.0](https://github.com/tang-vu/agenttrial/tree/orion-submission-v0.7.0). Ongoing paper experiments remain outside the product scoring path and cannot change a signed receipt or its embedded evaluator provenance.
