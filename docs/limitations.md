...
- EAS schema encoding, guarded idempotent broadcast, durable attachment state, receipt binding, and onchain payload verification are covered by deterministic/mocked tests. A real production receipt has also been [registered, broadcast, decoded, verified, and attached on Base Sepolia](https://base-sepolia.easscan.org/attestation/view/0xc62f196d7486b6463668aff181fe52daa87f362fa665823d44bb9ad348ff594c). Automatic per-run broadcasting remains operator-gated so anonymous traffic cannot spend testnet gas.
